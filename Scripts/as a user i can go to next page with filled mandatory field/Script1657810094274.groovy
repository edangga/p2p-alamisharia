...
WebUI.callTestCase(findTestCase('step/input data funder'), [('name') : 'testing', ('email') : ('emailtest' + now) + '@mail.com'
        , ('phoneNumber') : '08' + now, ('password') : 'Password150', ('userType') : 'Individual'], FailureHandling.STOP_ON_FAILURE)
